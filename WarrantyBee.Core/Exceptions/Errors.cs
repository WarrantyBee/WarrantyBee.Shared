...
/// <summary>
/// Represents a structured error in the application, containing a code, message, and status.
/// </summary>
...
/// <summary>
/// Provides a collection of predefined application errors for consistent error handling.
/// </summary>
